...
The app starts with a Startup screen image and displays all the champions in League of Legends in a collection view. This list is downloaded from the Riotgames API with the GET method /lol/static-data/v3/champions and is retrieving the image and lore tags only at the moment. If you want to know about a champion’s background, click on their image and it will take you to their lore page which you can read all about.
